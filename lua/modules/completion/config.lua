...
function config.nvim_lsp()
  ...
  require('lspconfig').yamlls.setup {
    ...
    settings = {
      yaml = {
        schemas = {
          ["/Users/yingkai.qyk/Workspace/ruijie/devops/pipeline-schema/product/product.schema.json"] = "/Users/yingkai.qyk/Workspace/ruijie/devops/pipeline-schema/product/*.(yaml,yml)",
